...
#define ARDRONE_NAVDATA_TIME_TAG (1)
#define ARDRONE_NAVDATA_RAW_MEASURES_TAG (2)
#define ARDRONE_NAVDATA_PHYS_MEASURES_TAG (3)
#define ARDRONE_NAVDATA_GYROS_OFFSETS_TAG (4)
#define ARDRONE_NAVDATA_EULER_ANGLES_TAG (5)
